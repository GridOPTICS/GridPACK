/*
 * ACML version 5.1.0 Copyright AMD,NAG 2003-2011
 */
...
extern double cla_gbrcond_c(char trans, int n, int kl, int ku, complex *ab, int ldab, complex *afb, int ldafb, int *ipiv, float *c, int capply, int *info);
extern double cla_gbrcond_x(char trans, int n, int kl, int ku, complex *ab, int ldab, complex *afb, int ldafb, int *ipiv, complex *x, int *info);
...
extern double cla_gbrpvgrw(int n, int kl, int ku, int ncols, complex *ab, int ldab, complex *afb, int ldafb);
extern void cla_geamv(int trans, int m, int n, float alpha, complex *a, int lda, complex *x, int incx, float beta, float *y, int incy);
extern double cla_gercond_c(char trans, int n, complex *a, int lda, complex *af, int ldaf, int *ipiv, float *c, int capply, int *info);
extern double cla_gercond_x(char trans, int n, complex *a, int lda, complex *af, int ldaf, int *ipiv, complex *x, int *info);
...
extern double cla_hercond_c(char uplo, int n, complex *a, int lda, complex *af, int ldaf, int *ipiv, float *c, int capply, int *info);
extern double cla_hercond_x(char uplo, int n, complex *a, int lda, complex *af, int ldaf, int *ipiv, complex *x, int *info);
...
extern double cla_herpvgrw(char uplo, int n, int *info, complex *a, int lda, complex *af, int ldaf, int *ipiv);
extern void cla_lin_berr(int n, int nz, int nrhs, complex *res, float *ayb, float *berr);
extern double cla_porcond_c(char uplo, int n, complex *a, int lda, complex *af, int ldaf, float *c, int capply, int *info);
extern double cla_porcond_x(char uplo, int n, complex *a, int lda, complex *af, int ldaf, complex *x, int *info);
...
extern double cla_porpvgrw(char uplo, int ncols, complex *a, int lda, complex *af, int ldaf);
extern double cla_rpvgrw(int n, int ncols, complex *a, int lda, complex *af, int ldaf);
extern void cla_syamv(int uplo, int n, float *alpha, complex *a, int lda, complex *x, int incx, float *beta, float *y, int incy);
extern double cla_syrcond_c(char uplo, int n, complex *a, int lda, complex *af, int ldaf, int *ipiv, float *c, int capply, int *info);
extern double cla_syrcond_x(char uplo, int n, complex *a, int lda, complex *af, int ldaf, int *ipiv, complex *x, int *info);
...
extern double cla_syrpvgrw(char uplo, int n, int *info, complex *a, int lda, complex *af, int ldaf, int *ipiv);
extern void cla_wwaddw(int n, complex *x, complex *y, complex *w);
extern double clanhf(char norm, char transr, char uplo, int n, complex *a);
...
extern double dla_rpvgrw(int n, int ncols, double *a, int lda, double *af, int ldaf);
...
extern float sla_rpvgrw(int n, int ncols, float *a, int lda, float *af, int ldaf);
...
extern double zla_rpvgrw(int n, int ncols, doublecomplex *a, int lda, doublecomplex *af, int ldaf);
...
extern double cla_gbrcond_c_(char *trans, int *n, int *kl, int *ku, complex *ab, int *ldab, complex *afb, int *ldafb, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int trans_len);
extern double cla_gbrcond_x_(char *trans, int *n, int *kl, int *ku, complex *ab, int *ldab, complex *afb, int *ldafb, int *ipiv, complex *x, int *info, complex *work, float *rwork, int trans_len);
extern void cla_gbrfsx_extended_(int *prec_type, int *trans_type, int *n, int *kl, int *ku, int *nrhs, complex *ab, int *ldab, complex *afb, int *ldafb, int *ipiv, int *colequ, float *c, complex *b, int *ldb, complex *y, int *ldy, float *berr_out, int *n_norms, float *err_bnds_norm, float *err_bnds_comp, complex *res, float *ayb, complex *dy, complex *y_tail, float *rcond, int *ithresh, float *rthresh, float *dz_ub, int *ignore_cwise, int *info);
extern double cla_gbrpvgrw_(int *n, int *kl, int *ku, int *ncols, complex *ab, int *ldab, complex *afb, int *ldafb);
...
extern double cla_gercond_c_(char *trans, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int trans_len);
extern double cla_gercond_x_(char *trans, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, complex *x, int *info, complex *work, float *rwork, int trans_len);
...
extern double cla_hercond_c_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int uplo_len);
extern double cla_hercond_x_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, complex *x, int *info, complex *work, float *rwork, int uplo_len);
...
extern double cla_herpvgrw_(char *uplo, int *n, int *info, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *work, int uplo_len);
extern void cla_lin_berr_(int *n, int *nz, int *nrhs, complex *res, float *ayb, float *berr);
extern double cla_porcond_c_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, float *c, int *capply, int *info, complex *work, float *rwork, int uplo_len);
extern double cla_porcond_x_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, complex *x, int *info, complex *work, float *rwork, int uplo_len);
...
extern double cla_porpvgrw_(char *uplo, int *ncols, complex *a, int *lda, complex *af, int *ldaf, float *work, int uplo_len);
extern double cla_rpvgrw_(int *n, int *ncols, complex *a, int *lda, complex *af, int *ldaf);
extern void cla_syamv_(int *uplo, int *n, float *alpha, complex *a, int *lda, complex *x, int *incx, float *beta, float *y, int *incy);
extern double cla_syrcond_c_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *c, int *capply, int *info, complex *work, float *rwork, int uplo_len);
extern double cla_syrcond_x_(char *uplo, int *n, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, complex *x, int *info, complex *work, float *rwork, int uplo_len);
...
extern double cla_syrpvgrw_(char *uplo, int *n, int *info, complex *a, int *lda, complex *af, int *ldaf, int *ipiv, float *work, int uplo_len);
extern void cla_wwaddw_(int *n, complex *x, complex *y, complex *w);
extern double clanhf_(char *norm, char *transr, char *uplo, int *n, complex *a, float *work, int norm_len, int transr_len, int uplo_len);
...
extern double dla_rpvgrw_(int *n, int *ncols, double *a, int *lda, double *af, int *ldaf);
...
extern double sla_rpvgrw_(int *n, int *ncols, float *a, int *lda, float *af, int *ldaf);
...
extern double zla_rpvgrw_(int *n, int *ncols, doublecomplex *a, int *lda, doublecomplex *af, int *ldaf);
