...
!
subroutine add_bus(n_handle, idx)
  use iso_c_binding
  implicit none
...
integer function total_branches(n_handle)
  ...
  integer, value, intent(in) :: n_handle
  integer(C_INT) c_handle, nbranch
  integer(C_INT) p_total_branches
  c_handle = n_handle
...
integer function get_reference_bus(n_handle)
  ...
  integer, value, intent(in) :: n_handle
  integer(C_INT) c_handle, c_idx
  integer(C_INT) p_get_reference_bus
  c_handle = n_handle
...
logical function set_original_bus_index(n_handle, idx, o_idx)
  ...
  logical(C_BOOL) p_set_original_bus_index
  c_handle = n_handle
  c_idx = idx
...
logical function set_global_bus_index(n_handle, idx, g_idx)
  ...
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_global_bus_index
  c_handle = n_handle
  c_idx = idx
...
logical function set_global_branch_index(n_handle, idx, g_idx)
  ...
  integer(C_INT) c_handle, c_idx, c_g_idx
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_global_branch_index
  c_handle = n_handle
  c_idx = idx
...
logical function set_original_bus_index1(n_handle, idx, b_idx)
  ...
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_original_bus_index1
  c_handle = n_handle
  c_idx = idx
  c_b_idx = b_idx
...
logical function set_original_bus_index2(n_handle, idx, b_idx)
  ...
  integer(C_INT) c_handle, c_idx, c_b_idx
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_original_bus_index2
  c_handle = n_handle
  c_idx = idx
  c_b_idx = b_idx
...
logical function set_global_bus_index1(n_handle, idx, b_idx)
  ...
  integer(C_INT) c_handle, c_idx, c_b_idx
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_global_bus_index1
  c_handle = n_handle
  c_idx = idx
  c_b_idx = b_idx
...
logical function set_global_bus_index2(n_handle, idx, b_idx)
  ...
  integer(C_INT) c_handle, c_idx, c_b_idx
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_global_bus_index2
  c_handle = n_handle
  c_idx = idx
  c_b_idx = b_idx
...
logical function set_local_bus_index1(n_handle, idx, b_idx)
  ...
  integer(C_INT) c_handle, c_idx, c_b_idx
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_local_bus_index1
  c_handle = n_handle
  c_idx = idx
  c_b_idx = b_idx
...
logical function set_local_bus_index2(n_handle, idx, b_idx)
  ...
  integer(C_INT) c_handle, c_idx, c_b_idx
  logical(C_BOOL) c_flag
  logical(C_BOOL) p_set_local_bus_index2
  c_handle = n_handle
  c_idx = idx
  c_b_idx = b_idx
...
logical function set_active_bus(n_handle, idx, flag)
  ...
  logical(C_BOOL) p_set_active_bus
  c_handle = n_handle
  c_idx = idx
  c_flag = flag
...
logical function set_active_branch(n_handle, idx, flag)
  ...
  integer(C_INT) c_handle, c_idx
  logical(C_BOOL) c_flag, c_ret
  logical(C_BOOL) p_set_active_branch
  c_handle = n_handle
  c_idx = idx
  c_flag = flag
...
logical function clear_branch_neighbors(n_handle, idx)
  ...
  logical(C_BOOL) p_clear_branch_neighbors
  c_handle = n_handle
  c_idx = idx
...
logical function add_branch_neighbor(n_handle, idx, br_idx)
  ...
  logical(C_BOOL) c_ret
  logical(C_BOOL) p_add_branch_neighbor
  c_handle = n_handle
  c_idx = idx
  c_br_idx = br_idx
...
logical function get_active_bus(n_handle, idx)
  ...
  integer(C_INT) c_handle, c_idx
  logical(C_BOOL) c_ret
  logical(C_BOOL) p_get_active_bus
  c_handle = n_handle
  c_idx = idx
...
integer function get_original_bus_index(n_handle, idx)
  ...
  integer(C_INT) c_handle, c_idx
  integer(C_INT) c_ret
  integer(C_INT) p_get_original_bus_index
  c_handle = n_handle
  c_idx = idx
...
integer function get_global_bus_index(n_handle, idx)
  ...
  integer(C_INT) c_handle, c_idx
  integer(C_INT) c_ret
  integer(C_INT) p_get_global_bus_index
  c_handle = n_handle
  c_idx = idx
...
logical function get_active_branch(n_handle, idx)
  ...
  integer(C_INT) c_handle, c_idx
  logical(C_BOOL) c_ret
  logical(C_BOOL) p_get_active_branch
  c_handle = n_handle
  c_idx = idx
...
integer function get_global_branch_index(n_handle, idx)
  ...
  integer(C_INT) c_handle, c_idx
  integer(C_INT) c_ret
  integer(C_INT) p_get_global_branch_index
  c_handle = n_handle
  c_idx = idx
...
integer function get_num_connected_branches(n_handle, idx)
  ...
  integer(C_INT) c_handle, c_idx
  integer(C_INT) c_ret
  integer(C_INT) p_get_num_connected_branches
  c_handle = n_handle
  c_idx = idx
...
subroutine get_connected_branches(n_handle, idx, branches)
  ...
  c_handle = n_handle
  c_idx = idx
  c_num = p_get_num_connected_branches
