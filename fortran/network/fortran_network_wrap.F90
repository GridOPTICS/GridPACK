...
!
!    integer(C_INT) function p_create_network(comm) &
!        bind(c, name="p_create_network")
...
!
    subroutine p_add_bus(n_handle, idx) bind(c, name="p_add_bus")
      use, intrinsic :: iso_c_binding
      implicit none
      type (c_ptr), intent(in) :: n_handle
      integer(C_INT), value, intent(in) :: idx
    end subroutine p_add_bus
!
! Add a branch locally to the network
!
    subroutine p_add_branch(n_handle, idx1, idx2) &
        bind(c, name="p_add_branch")
      use, intrinsic :: iso_c_binding
      implicit none
...
!
    integer(C_INT) function p_num_buses(n_handle) &
        bind(c, name="p_num_buses")
      use, intrinsic :: iso_c_binding
      implicit none
...
!
    integer(C_INT) function p_total_buses(n_handle) &
        bind(c, name="p_total_buses")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    integer(C_INT) function p_num_branches(n_handle) &
        bind(c, name="p_num_branches")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
! Return the total number of buses in the entire network
!
    integer(C_INT) function p_total_branches(n_handle) &
        bind(c, name="p_total_branches")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    subroutine p_set_reference_bus(n_handle, idx) &
        bind(c, name="p_set_reference_bus")
      use, intrinsic :: iso_c_binding
      implicit none
...
!
    subroutine p_partition_network(n_handle) &
        bind(c, name="p_partition_network")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    subroutine p_clean_network(n_handle) &
        bind(c, name="p_clean_network")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    subroutine p_init_bus_update(n_handle) &
        bind(c, name="p_init_bus_update")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    subroutine p_update_buses(n_handle) &
        bind(c, name="p_update_buses")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    subroutine p_init_branch_update(n_handle) &
        bind(c, name="p_init_branch_update")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
...
!
    subroutine p_update_branches(n_handle) &
        bind(c, name="p_update_branches")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(C_INT), value, intent(in) :: n_handle
    end subroutine p_update_branches
  end interface
end module p_gridpack_network
