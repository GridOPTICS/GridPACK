...
\begin{figure}
  \centering
    \includegraphics*[width=6.32in, height=3.82in, keepaspectratio=false, trim=0.01in 0.81in 0.17in 0.24in]{figures/Communicator.png}
...
\begin{figure}
  \centering
    \includegraphics*[width=5.52in, height=2.95in, keepaspectratio=true]{figures/Mult-parallel.png}
...
Again, a global maximum or minimum can be calculated by first computing the
