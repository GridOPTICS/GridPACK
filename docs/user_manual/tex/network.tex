...
keepaspectratio=true]{figures/Grid-network.png}
...
\begin{figure}
  \centering
%    \includegraphics*[width=3.5in, keepaspectratio=true, trim=0.00in 0.30in
%0.00in 0.40in]{figures/PartitionFull.png}
    \includegraphics*[width=4in, % height=3.55in,
keepaspectratio=true] {figures/PartitionFull.png}

    \includegraphics*[width=4in, % height=3.55in,
keepaspectratio=true]{figures/Partition0.png}

    \includegraphics*[width=4in, % height=3.55in,
keepaspectratio=true]{figures/Partition1.png}
