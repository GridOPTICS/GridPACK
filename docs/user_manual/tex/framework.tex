...
\begin{figure}
  \centering
    \includegraphics*[width=6in, height=3.81in, keepaspectratio=true]{figures/Relationship-Grid-components.png}
...
\begin{figure}
  \centering
    \includegraphics*[width=6in, height=4.05in, keepaspectratio=true]{figures/Grid-framework-schematic.png}
