...
freedom to express their models and algorithms using.
...
\begin{figure}
\centering
\includegraphics[width=3.5in,keepaspectratio=true]{./Fig3a}
\includegraphics[width=3.5in,keepaspectratio=true]{./Fig3b}
\includegraphics[width=3.5in,keepaspectratio=true]{./Fig3c}
\includegraphics[width=3.5in,keepaspectratio=true]{./Fig3d}
...
available for download at https://github.com/GridOPTICS/GridPACK.
