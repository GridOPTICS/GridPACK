...
!
  ...
  do j = 1, maxdim
    do i = 1, maxdim
      ...
      write(6,'(a,f8.3)',advance='no') ',',dble(mod((n-1),100))  !maps to LOAD_PL
      write(6,'(a,f8.3)',advance='no') ',',dble(mod(n,100)) !maps to LOAD_QL
...
! map to BRANCH_RATING_A
      write(6,'(a,f6.2)',advance='no') ',',dble(mod(icnt,100)) 
