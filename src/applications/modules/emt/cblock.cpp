...
void Cblock::updatestate(double u,double dt,double xmin,double xmax,double dxmin, double dxmax)
{
  double xout,dx_dt;
...
{
  updatestate(u,dt,p_xmin,p_xmax,p_dxmin,p_dxmax);
}
...
double Cblock::getoutput(double u,double dt,double xmin,double xmax,double ymin,double ymax,bool dostateupdate)
{
  ...
  if(dostateupdate) {
    updatestate(u,dt,xmin,xmax,p_dxmin,p_dxmax);
  }

  return y_n;
}

double Cblock::getoutput(double u,double dt,double xmin,double xmax,double dxmin, double dxmax,double ymin,double ymax, bool dostateupdate)
{
  double y;
  ...
  y = getoutput(u,dt,xmin,xmax,ymin,ymax,dostateupdate);

  return y;
}


double Cblock::getoutput(double u,double dt,bool dostateupdate)
{
  double y;

  y = getoutput(u,dt,p_xmin,p_xmax,p_ymin,p_ymax,dostateupdate);
