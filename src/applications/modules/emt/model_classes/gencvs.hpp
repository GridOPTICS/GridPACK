 ...
 * @file   gencvs.hpp
 * 
 * @brief Constant (internal) voltage source generator model 
 * 
 * 
 */

#ifndef _gencvs_model_h_
#define _gencvs_model_h_

#include <base_gen_model.hpp>
#include <gridpack/include/gridpack.hpp>


class Gencvs: public BaseEMTGenModel
{
   public:
  /**
     * Basic constructor
  ...
  */
  ...
  private:
    ...
    double delta;  // internal voltage source angle
