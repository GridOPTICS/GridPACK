...
class Genrou: public BaseEMTGenModel
{
  ...
  */ 
  ...
  // Machine EMT parameters
  double L_ad, L_aq, L_l, L_d, L_q, L_fd, L_1q;
  double L_1d, R_1d, L_2q, R_2q, R_fd, R_1q;
  double R_a, L_f1d, L_ffd, L_11d, L_11q, L_22q;
  double w_base, w_r;
  
  double LadIfd; // Field current
  
  double TM, TE; // Mechanical torque (from governor if avaiable otherwise constant)
  ...
  // Generator EMT variables and their derivatives
  double psi_d, psi_q, psi_fd, psi_1d, psi_1q, psi_2q, delt_w_r, delta; 
  double d_psi_d, d_psi_q, d_psi_fd, d_psi_1d, d_psi_1q, d_psi_2q, d_delt_w_r, d_delta; 
  double iabc[3], e_fd;
  double i_fd, i_1d, i_1q, i_2q;
  double k_te;
