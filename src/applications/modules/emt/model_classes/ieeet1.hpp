 ...
 * @file   ieeet1.hpp
 * 
 * @brief IEEET1 exciter model header file 
 * 
 * 
 */
...
class Ieeet1: public BaseEMTExcModel
{
public:
  /**
   * Basic constructor
...
private:
  ...
  // Exciter ieeet1 parameters from dyr
  double TR, VRmax, VRmin;
  double KA, TA, KE, TE;
  double KF, TF;
  int    SWITCH;
  
  // IEEET1 state variables
...
public:
  ...
  // Default constructor
  Ieeet1Event(Ieeet1 *exc):gridpack::math::RealDAESolver::Event(2),p_exc(exc)
  {
