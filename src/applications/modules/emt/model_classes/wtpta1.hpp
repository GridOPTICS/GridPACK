 ...
 * @file  wtpta1.hpp
 * 
 * @brief  Header file for WTPTA1 pitch controller
 * 
 * 
 */
...
class Wtpta1 : public BaseEMTRMechModel
{
...
public:
  ...
  // Default constructor
  Wtpta1Event(Wtpta1 *wtpta1):gridpack::math::RealDAESolver::Event(0),p_pitchcon(wtpta1)
  {
