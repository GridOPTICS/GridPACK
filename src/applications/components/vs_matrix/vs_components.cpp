 ...
 *  Simple constructor
 */
gridpack::voltage_stability::VSBus::VSBus(void)
{
  p_shunt_gs = 0.0;
  p_shunt_bs = 0.0;
  p_v = 0.0;
 ...
 */
bool gridpack::voltage_stability::VSBus::matrixDiagSize(int *isize,
    int *jsize) const
{
  if (p_mode == VS_Jacobian) {
    if (!isIsolated()) {
#ifdef LARGE_MATRIX
      *isize = 2;
      *jsize = 2;
 ...
 * @return: false if network component does not contribute matrix element
 */
bool gridpack::voltage_stability::VSBus::matrixDiagValues(ComplexType *values)
{
  if (p_mode == VS_YBus) {
    return YMBus::matrixDiagValues(values);
  } else if (p_mode == VS_Jacobian) {
    double rvals[4];
...
bool gridpack::voltage_stability::VSBus::matrixDiagValues(RealType *values)
{
  if (p_mode == VS_Jacobian) {
 ...
 */
bool gridpack::voltage_stability::VSBus::vectorSize(int *size) const
{
  if (p_mode == VS_RHS || p_mode == VS_State) {
    if (!isIsolated()) {
#ifdef LARGE_MATRIX
      *size = 2;
      return true;
 ...
 *        vector element
 */
bool gridpack::voltage_stability::VSBus::vectorValues(ComplexType *values)
{
  if (p_mode == VS_S_Cal)  {
    ...
    values[0] = ret;
    return true;
  } else if (p_mode == VS_State) {
    values[0] = p_v;
    values[1] = p_a;
    return true;
  } else if (p_mode == VS_RHS) {
    double rvals[2];
...
bool gridpack::voltage_stability::VSBus::vectorValues(RealType *values)
{
  if (p_mode == VS_State) {
    values[0] = p_v;
    values[1] = p_a;
 ...
 * 
 */
bool gridpack::voltage_stability::VSBus::chkQlim(void)
{
  if (p_isPV) {
 ...
 */
void gridpack::voltage_stability::VSBus::clearQlim()
{
 ...
 */
void gridpack::voltage_stability::VSBus::setValues(gridpack::ComplexType *values)
{
  double vt = p_v;
  double at = p_a;
  p_a -= real(values[0]);
...
void gridpack::voltage_stability::VSBus::setValues(gridpack::RealType *values)
{
  double vt = p_v;
  double at = p_a;
  p_a -= values[0];
 ...
 */
int gridpack::voltage_stability::VSBus::getXCBufSize(void)
{
 ...
 */
void gridpack::voltage_stability::VSBus::setXCBuf(void *buf)
{
...
/**
 * Load values stored in DataCollection object into VSBus object. The
 * DataCollection object will have been filled when the network was created
 * from an external configuration file
 * @param data: DataCollection object contain parameters relevant to this
 *       bus that were read in when network was initialized
 */
void gridpack::voltage_stability::VSBus::load(
 ...
 * calculations
 */
void gridpack::voltage_stability::VSBus::setYBus(void)
{
  YMBus::setYBus();
 ...
 * calculations
 */
gridpack::ComplexType gridpack::voltage_stability::VSBus::getYBus(void)
{
 ...
 */
void gridpack::voltage_stability::VSBus::setMode(int mode)
{
  if (mode == VS_YBus) {
 ...
 */
void gridpack::voltage_stability::VSBus::resetVoltage(void)
{
  p_v = p_voltage;
  p_a = p_angle;
  if (p_vMag_ptr) *p_vMag_ptr = p_v;
 ...
 */
void gridpack::voltage_stability::VSBus::setVoltageLimits(double vmin, double vmax)
{
  p_vmin = vmin;
  p_vmax = vmax;
}
 ...
 */
bool gridpack::voltage_stability::VSBus::checkVoltageViolation()
{
  bool ret = true;
 ...
 */
double gridpack::voltage_stability::VSBus::getVoltage()
{
  return *p_vMag_ptr;
}
 ...
 */
bool gridpack::voltage_stability::VSBus::isPV(void)
{
  return p_isPV;
}
 ...
 * @return: phase angle
 */
double gridpack::voltage_stability::VSBus::getPhase()
{
  return *p_vAng_ptr;
}
 ...
 */
bool gridpack::voltage_stability::VSBus::getGenStatus(std::string gen_id)
{
  int i;
 ...
 */
std::vector<std::string> gridpack::voltage_stability::VSBus::getGenerators()
{
  return p_gid;
}
 ...
 * @return vector of generator IDs
 */
std::vector<std::string> gridpack::voltage_stability::VSBus::getLoads()
{
  return p_lid;
}
 ...
 */
void gridpack::voltage_stability::VSBus::setGenStatus(std::string gen_id, bool status)
{
  int i;
  int gsize = p_gstatus.size();
  for (i=0; i<gsize; i++) {
 ...
 */
void gridpack::voltage_stability::VSBus::setIsPV(int status)
{
  p_saveisPV = p_isPV;
  p_isPV = status;
 ...
 * Reset isPV status
 */
void gridpack::voltage_stability::VSBus::resetIsPV()
{
  p_isPV = p_saveisPV;
 ...
 */
void gridpack::voltage_stability::VSBus::setSBus(void)
{
  int i;
  double pg, qg, pl, ql;
  pg = 0.0;
 ...
 **/
/*
void gridpack::voltage_stability::VSBus::updatePg(int busID, std::string genID, double value)
{
 ...
 */
bool gridpack::voltage_stability::VSBus::serialWrite(char *string, const int bufsize,
                                             const char *signal)
{
  if (signal == NULL) {
    double pi = 4.0*atan(1.0);
    ...
    if (getReferenceBus() || isIsolated()) {
      ...
      for (i=0; i<size; i++) {
        gridpack::voltage_stability::VSBranch *branch
          = dynamic_cast<gridpack::voltage_stability::VSBranch*>(
              branches[i].get());
 ...
 */
gridpack::ComplexType gridpack::voltage_stability::VSBus::getComplexVoltage(void)
{
  p_a = *p_vAng_ptr;
  p_v =  *p_vMag_ptr;
 ...
 */
void gridpack::voltage_stability::VSBus::saveData(
    boost::shared_ptr<gridpack::component::DataCollection> data)
{
  ...
  if (getReferenceBus() || isIsolated()) {
    ...
    for (i=0; i<size; i++) {
      gridpack::voltage_stability::VSBranch *branch
        = dynamic_cast<gridpack::voltage_stability::VSBranch*>(branches[i].get());
      branch->getPQ(this, &p, &q);
      P += p;
      Q += q;
    }
 ...
 */
void gridpack::voltage_stability::VSBus::saveDataAlsotoOrg(
    boost::shared_ptr<gridpack::component::DataCollection> data)
{
  double rval;
  int i;
 ...
 */
void gridpack::voltage_stability::VSBus::setParam(std::string name, int busID, 
 ...
 * @param value new value of parameter
 */
void gridpack::voltage_stability::VSBus::setParam(int busID, 
    std::string genID, double value) 
{
//  if (name == GENERATOR_PG) {
   if (getOriginalIndex() == busID) {
 ...
 */
void gridpack::voltage_stability::VSBus::getParam(std::string &name,
 ...
 */
int gridpack::voltage_stability::VSBus::getElementIndex(std::string &name, std::string &tag)
{
  if (name == "GENERATOR") {
    int i;
 ...
 */
void gridpack::voltage_stability::VSBus::setIgnore(bool flag)
{
  p_ignore = flag;
}
 ...
 */
bool gridpack::voltage_stability::VSBus::getIgnore()
{
  return p_ignore;
}
 ...
 */
int gridpack::voltage_stability::VSBus::getArea()
{
  return p_area;
}
 ...
 */
int gridpack::voltage_stability::VSBus::getZone()
{
  return p_zone;
}
 ...
 */
int gridpack::voltage_stability::VSBus::diagonalJacobianValues(double *rvals)
{
  if (!isIsolated()) {
#ifdef LARGE_MATRIX
    if (!getReferenceBus()) {
 ...
 */
void gridpack::voltage_stability::VSBus::pushIsPV()
{
 ...
 * @return number of values returned
 */
int gridpack::voltage_stability::VSBus::rhsValues(double *rvals)
{
  if (!isIsolated()) {
    if (!getReferenceBus()) {
      int nvals;
 ...
 */
std::vector<double> gridpack::voltage_stability::VSBus::getGeneratorParticipation()
{
  return p_pFac;
}
 ...
 */
void gridpack::voltage_stability::VSBus::setGeneratorRealPower(
 ...
 * @param data data collection object associated with
 bus
 */
void gridpack::voltage_stability::VSBus::setGeneratorStatus(
 ...
 */
void gridpack::voltage_stability::VSBus::scaleGeneratorRealPower(std::string tag,
    double value)
{
  int i;
  for (i=0; i<p_ngen; i++) {
 ...
 * @param data data collection object associated with bus
 */
void gridpack::voltage_stability::VSBus::setLoadRealPower(
    std::string tag, double value, gridpack::component::DataCollection *data)
{
  int i, idx;
  idx = -1;
 ...
 * @param value scale factor for real power
 */
void gridpack::voltage_stability::VSBus::scaleLoadPower(std::string tag, double value)
{
  int i;
  for (i=0; i<p_nload; i++) {
 ...
 * @param status current status of generator
 */
void gridpack::voltage_stability::VSBus::getGeneratorMargins(
 ...
 */
void gridpack::voltage_stability::VSBus::getLoadPower(
 ...
 */
void gridpack::voltage_stability::VSBus::setSource(bool flag)
{
  p_source = flag;
}
 ...
 */
void gridpack::voltage_stability::VSBus::setSink(bool flag)
{
  p_sink = flag;
}
 ...
 */
void gridpack::voltage_stability::VSBus::setScale(double scale)
{
  p_rtpr_scale = scale;
}
 ...
 *  Simple constructor
 */
gridpack::voltage_stability::VSBranch::VSBranch(void)
{
  p_reactance.clear();
  p_resistance.clear();
  p_tap_ratio.clear();
 ...
 * @return: false if network component does not contribute matrix element
 */
bool gridpack::voltage_stability::VSBranch::matrixForwardSize(int *isize, int *jsize) const
{
  if (p_mode == VS_Jacobian) {
...
bool gridpack::voltage_stability::VSBranch::matrixReverseSize(int *isize, int *jsize) const
{
  if (p_mode == VS_Jacobian) {
    gridpack::voltage_stability::VSBus *bus1
      = dynamic_cast<gridpack::voltage_stability::VSBus*>(getBus1().get());
 ...
 * @return: false if network component does not contribute matrix element
 */
bool gridpack::voltage_stability::VSBranch::matrixForwardValues(ComplexType *values)
{
  if (p_mode == VS_Jacobian) {
    double rvals[4];
...
bool gridpack::voltage_stability::VSBranch::matrixForwardValues(RealType *values)
{
  if (p_mode == VS_Jacobian) {
...
bool gridpack::voltage_stability::VSBranch::matrixReverseValues(ComplexType *values)
{
  if (p_mode == VS_Jacobian) {
    double rvals[4];
...
bool gridpack::voltage_stability::VSBranch::matrixReverseValues(RealType *values)
{
  if (p_mode == VS_Jacobian) {
...
void gridpack::voltage_stability::VSBranch::setYBus(void)
{
  YMBranch::setYBus();
  gridpack::ComplexType ret;
...
/**
 * Load values stored in DataCollection object into VSBranch object. The
 * DataCollection object will have been filled when the network was created
 * from an external configuration file
 * @param data: DataCollection object contain parameters relevant to this
 *       branch that were read in when network was initialized
 */
void gridpack::voltage_stability::VSBranch::load(
    const boost::shared_ptr<gridpack::component::DataCollection> &data)
{
  YMBranch::load(data);
 ...
 * @param mode: enumerated constant for different modes
 */
void gridpack::voltage_stability::VSBranch::setMode(int mode)
{
  if (mode == VS_YBus) {
 ...
 */
void gridpack::voltage_stability::VSBranch::getJacobian(gridpack::voltage_stability::VSBus *bus, double *values)
{
  double v;
  double cs, sn;
  double ybusr, ybusi;
 ...
 */
void gridpack::voltage_stability::VSBranch::getPQ(gridpack::voltage_stability::VSBus *bus, double *p, double *q)
{
  gridpack::voltage_stability::VSBus *bus1 = 
    dynamic_cast<gridpack::voltage_stability::VSBus*>(getBus1().get());
 ...
 */
gridpack::ComplexType gridpack::voltage_stability::VSBranch::getComplexPower(
        std::string tag)
{
 ...
 */
bool gridpack::voltage_stability::VSBranch::FVSIWrite()
{
  printf("\n FVSI Write \n");
  ...
  for (i=0; i<bsize; i++) {
    ...
    printf("%6d %6d %s %20.12e %20.12e %20.12e %20.12e %1d  %3f\n",
 ...
 */
bool gridpack::voltage_stability::VSBranch::getBranchStatus(std::string tag)
{
  int i;
 ...
 */
void gridpack::voltage_stability::VSBranch::setBranchStatus(std::string tag, bool status)
{
  int i;
  int bsize = p_branch_status.size();
  for (i=0; i<bsize; i++) {
 ...
 */
double gridpack::voltage_stability::VSBranch::getBranchRatingA(std::string tag)
{
  int i;
  int bsize = p_ckt.size();
  double ret = 0.0;
 ...
 * @return branch rating value
 */
double gridpack::voltage_stability::VSBranch::getBranchRatingB(std::string tag)
{
  int i;
  int bsize = p_ckt.size();
  double ret = 0.0;
 ...
 * @return branch rating value
 */
double gridpack::voltage_stability::VSBranch::getBranchRatingC(std::string tag)
{
  int i;
  int bsize = p_ckt.size();
  double ret = 0.0;
 ...
 */
std::vector<std::string> gridpack::voltage_stability::VSBranch::getLineIDs()
{
  return p_ckt;
}
 ...
 * @param flag value of ignore parameter
 */
void gridpack::voltage_stability::VSBranch::setIgnore(std::string tag, bool flag)
{
  int i;
  int bsize = p_ckt.size();
  for (i=0; i<bsize; i++) {
 ...
 * @return value of ignore parameter
 */
bool gridpack::voltage_stability::VSBranch::getIgnore(std::string tag)
{
  int i;
  int bsize = p_ckt.size();
  bool ret = false;
 ...
 * @return number of values returned
 */
int gridpack::voltage_stability::VSBranch::forwardJacobianValues(double *rvals)
{
  gridpack::voltage_stability::VSBus *bus1
    = dynamic_cast<gridpack::voltage_stability::VSBus*>(getBus1().get());
  gridpack::voltage_stability::VSBus *bus2
...
int gridpack::voltage_stability::VSBranch::reverseJacobianValues(double *rvals)
{
  gridpack::voltage_stability::VSBus *bus1
    = dynamic_cast<gridpack::voltage_stability::VSBus*>(getBus1().get());
  gridpack::voltage_stability::VSBus *bus2
