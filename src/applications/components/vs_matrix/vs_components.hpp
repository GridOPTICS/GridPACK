...
#ifndef _vs_components_h_
#define _vs_components_h_
...
enum VSMode{VS_YBus, VS_Jacobian, VS_RHS, VS_S_Cal, VS_State};
...
class VSBranch
  ...
  public:
     ...
     */
    void getJacobian(VSBus *bus, double *values);
...
BOOST_CLASS_EXPORT_KEY(gridpack::voltage_stability::VSBus)
BOOST_CLASS_EXPORT_KEY(gridpack::voltage_stability::VSBranch)
