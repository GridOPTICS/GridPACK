...
#ifndef PTI35_PARSER_HPP_
#define PTI35_PARSER_HPP_
...
class PTI35_parser : public BasePTIParser<_network>
{
  public:
    /// Constructor 
    /**
     ...
     */
    PTI35_parser(boost::shared_ptr<_network> network)
