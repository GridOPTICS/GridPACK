...
#ifndef PTI36_PARSER_HPP_
#define PTI36_PARSER_HPP_
...
#include "gridpack/parser/block_parsers/v_droop_ctrl_parser36.hpp"
#include "gridpack/parser/block_parsers/generator_parser35.hpp"
#include "gridpack/parser/block_parsers/swtch_dev_rating_tbl_parser36.hpp"
#include "gridpack/parser/block_parsers/branch_parser36.hpp"
...
#include "gridpack/parser/block_parsers/switched_shunt_parser36.hpp"
...
class PTI36_parser : public BasePTIParser<_network>
{
  public:
    /// Constructor 
    /**
     ...
     */
    PTI36_parser(boost::shared_ptr<_network> network)
  ...
  protected:
    ...
    void getCase()
    {
      ...
      if (me == 0) {
        ...
        gridpack::parser::VDroopCtrlParser36 v_droop_ctrl_parser(&p_busMap,
            &p_nameMap, &p_branchMap);
        v_droop_ctrl_parser.parse(p_istream);
        gridpack::parser::GeneratorParser35 generator_parser(&p_busMap,
            &p_nameMap, &p_branchMap);
        generator_parser.parse(p_istream,p_busData);
        gridpack::parser::SwtchDevRatingTblParser36 swtch_dev_rat_tbl_parser(
            &p_busMap, &p_nameMap, &p_branchMap);
        swtch_dev_rat_tbl_parser.parse(p_istream);
        gridpack::parser::BranchParser36 branch_parser(&p_busMap,
            &p_nameMap, &p_branchMap);
        ...
        gridpack::parser::SwitchedShuntParser36 switched_shunt_parser(&p_busMap,
            &p_nameMap, &p_branchMap);
