...
class PTI34_parser : public BasePTIParser<_network>
{
  public:
    /// Constructor 
    /**
     ...
     */
    PTI34_parser(boost::shared_ptr<_network> network)
  ...
  protected:
    ...
    void getCase()
    {
      ...
      if (me == 0) {
        ...
        gridpack::parser::GeneratorParser34 generator_parser(&p_busMap,
            &p_nameMap, &p_branchMap);
