 ...
 *
 *
 *      switched_shunt_parser36.cpp
 *       Created on: February 18, 2025
 *           Author: Bruce Palmer
 */
#include "switched_shunt_parser36.hpp"
 ...
 * @param branch_map map bus index pair in RAW file to
 internal indices
 */
gridpack::parser::SwitchedShuntParser36::SwitchedShuntParser36(
 ...
 * Simple Destructor
 */
gridpack::parser::SwitchedShuntParser36::~SwitchedShuntParser36(void)
{
}
 ...
 */
void gridpack::parser::SwitchedShuntParser36::parse(
    ...
    std::vector<boost::shared_ptr<gridpack::component::DataCollection> > &p_busData)
{
  ...
  while(test_end(line)) {
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_MODSW,
      ...
      p_busData[o_idx]->addValue(SHUNT_MODSW, atoi(split_line[2].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_ADJM,
      ...
      p_busData[o_idx]->addValue(SHUNT_ADJM, atoi(split_line[3].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_SWCH_STAT,
          atoi(split_line[4].c_str()))) {
      p_busData[o_idx]->addValue(SHUNT_SWCH_STAT, atoi(split_line[4].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_VSWHI,
      ...
      p_busData[o_idx]->addValue(SHUNT_VSWHI, atof(split_line[5].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_VSWLO,
      ...
      p_busData[o_idx]->addValue(SHUNT_VSWLO, atof(split_line[6].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_SWREG,
          atoi(split_line[7].c_str()))) {
      p_busData[o_idx]->addValue(SHUNT_SWREG, atoi(split_line[7].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_NREG,
          atoi(split_line[8].c_str()))) {
      p_busData[o_idx]->addValue(SHUNT_SWREG, atoi(split_line[8].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_RMPCT,
      ...
      p_busData[o_idx]->addValue(SHUNT_RMPCT, atof(split_line[9].c_str()));
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_RMIDNT,
          split_line[10].c_str())) {
      p_busData[o_idx]->addValue(SHUNT_RMIDNT, split_line[10].c_str());
    }
    ...
    if (!p_busData[o_idx]->setValue(SHUNT_BINIT,
      ...
      p_busData[o_idx]->addValue(SHUNT_BINIT, atof(split_line[11].c_str()));
    }
     ...
     */
    if (split_line[12].find_first_of('\'',0) != std::string::npos) {
     ...
     */
    if (nval > 13) {
      if (!p_busData[o_idx]->setValue(SHUNT_S1,
            atoi(split_line[13].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S1, atoi(split_line[13].c_str()));
      }
    }
     ...
     */
    if (nval > 16) {
      if (!p_busData[o_idx]->setValue(SHUNT_S2,
            atoi(split_line[16].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S2, atoi(split_line[16].c_str()));
      }
    }
     ...
     */
    if (nval > 19) {
      if (!p_busData[o_idx]->setValue(SHUNT_S3,
            atoi(split_line[19].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S3, atoi(split_line[19].c_str()));
      }
    }
     ...
     */
    if (nval > 22) {
      if (!p_busData[o_idx]->setValue(SHUNT_S4,
            atoi(split_line[22].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S4, atoi(split_line[22].c_str()));
      }
    }
     ...
     */
    if (nval > 25) {
      if (!p_busData[o_idx]->setValue(SHUNT_S5,
            atoi(split_line[25].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S5, atoi(split_line[25].c_str()));
      }
    }
     ...
     */
    if (nval > 28) {
      if (!p_busData[o_idx]->setValue(SHUNT_S6,
            atoi(split_line[28].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S6, atoi(split_line[28].c_str()));
      }
    }
     ...
     */
    if (nval > 31) {
      if (!p_busData[o_idx]->setValue(SHUNT_S7,
            atoi(split_line[31].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S7, atoi(split_line[31].c_str()));
      }
    }
     ...
     */
    if (nval > 34) {
      if (!p_busData[o_idx]->setValue(SHUNT_S8,
            atoi(split_line[34].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_S8, atoi(split_line[34].c_str()));
      }
    }
    ...
    if (nval > 14) {
      if (!p_busData[o_idx]->setValue(SHUNT_N1,
        ...
        p_busData[o_idx]->addValue(SHUNT_N1, atoi(split_line[14].c_str()));
      }
    }
    ...
    if (nval > 17) {
      if (!p_busData[o_idx]->setValue(SHUNT_N2,
            atoi(split_line[17].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_N2, atoi(split_line[17].c_str()));
      }
    }
    ...
    if (nval > 20) {
      if (!p_busData[o_idx]->setValue(SHUNT_N3,
        ...
        p_busData[o_idx]->addValue(SHUNT_N3, atoi(split_line[20].c_str()));
      }
    }
    ...
    if (nval > 23) {
      if (!p_busData[o_idx]->setValue(SHUNT_N4,
            atoi(split_line[23].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_N4, atoi(split_line[23].c_str()));
      }
    }
    ...
    if (nval > 26) {
      if (!p_busData[o_idx]->setValue(SHUNT_N5,
        ...
        p_busData[o_idx]->addValue(SHUNT_N5, atoi(split_line[26].c_str()));
      }
    }
    ...
    if (nval > 29) {
      if (!p_busData[o_idx]->setValue(SHUNT_N6,
            atoi(split_line[29].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_N6, atoi(split_line[29].c_str()));
      }
    }
    ...
    if (nval > 32) {
      if (!p_busData[o_idx]->setValue(SHUNT_N7,
            atoi(split_line[32].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_N7, atoi(split_line[32].c_str()));
      }
    }
    ...
    if (nval > 35) {
      if (!p_busData[o_idx]->setValue(SHUNT_N8,
            atoi(split_line[35].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_N8, atoi(split_line[35].c_str()));
      }
    }
    ...
    if (nval > 15) {
      if (!p_busData[o_idx]->setValue(SHUNT_B1,
        ...
        p_busData[o_idx]->addValue(SHUNT_B1, atof(split_line[15].c_str()));
      }
    }
    ...
    if (nval > 18) {
      if (!p_busData[o_idx]->setValue(SHUNT_B2,
            atof(split_line[18].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_B2, atof(split_line[18].c_str()));
      }
    }
    ...
    if (nval > 21) {
      if (!p_busData[o_idx]->setValue(SHUNT_B3,
        ...
        p_busData[o_idx]->addValue(SHUNT_B3, atof(split_line[21].c_str()));
      }
    }
    ...
    if (nval > 24) {
      if (!p_busData[o_idx]->setValue(SHUNT_B4,
            atof(split_line[24].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_B4, atof(split_line[24].c_str()));
      }
    }
    ...
    if (nval > 27) {
      if (!p_busData[o_idx]->setValue(SHUNT_B5,
            atof(split_line[27].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_B5, atof(split_line[27].c_str()));
      }
    }
    ...
    if (nval > 30) {
      if (!p_busData[o_idx]->setValue(SHUNT_B6,
            atof(split_line[30].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_B6, atof(split_line[30].c_str()));
      }
    }
    ...
    if (nval > 33) {
      if (!p_busData[o_idx]->setValue(SHUNT_B7,
            atof(split_line[33].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_B7, atof(split_line[33].c_str()));
      }
    }
    ...
    if (nval > 36) {
      if (!p_busData[o_idx]->setValue(SHUNT_B8,
            atof(split_line[36].c_str()))) {
        p_busData[o_idx]->addValue(SHUNT_B8, atof(split_line[36].c_str()));
      }
    }
