 ...
 *
 *
 *     switched_shunt_parser36.hpp
 *       Created on: February 18, 2025
 *           Author: Bruce Palmer
 */
#ifndef _SWITCHED_SHUNT_PARSER36_H
#define _SWITCHED_SHUNT_PARSER36_H
...
class SwitchedShuntParser36 : public BaseBlockParser {
  public:
  /**
   * Constructor
   ...
   * Simple Destructor
   */
  virtual ~SwitchedShuntParser36(void);
