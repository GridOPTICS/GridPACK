 ...
 */
gridpack::parser::FACTSParser33::FACTSParser33(
 ...
 * Simple Destructor
 */
gridpack::parser::FACTSParser33::~FACTSParser33(void)
{
}

/**
 * parse FACTS block. Currently does not store data
 * @param stream input stream that feeds lines from RAW file
 */
void gridpack::parser::FACTSParser33::parse(
