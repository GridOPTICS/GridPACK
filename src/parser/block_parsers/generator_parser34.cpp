 ...
 *
 *
 * generator_parser34.cpp
 *       Created on: December 9, 2022
 *           Author: Bruce Palmer
 */
#include "generator_parser34.hpp"
 ...
 * @param branch_map map bus index pair in RAW file to
 internal indices
 */
gridpack::parser::GeneratorParser34::GeneratorParser34(
 ...
 * Simple Destructor
 */
gridpack::parser::GeneratorParser34::~GeneratorParser34(void)
{
}
 ...
 */
void gridpack::parser::GeneratorParser34::parse(
    ...
    std::vector<boost::shared_ptr<gridpack::component::DataCollection> > &p_busData)
{
  ...
  while(test_end(line)) {
    ...
    if (nstr > 28) p_busData[l_idx]->addValue(GENERATOR_NREG,
