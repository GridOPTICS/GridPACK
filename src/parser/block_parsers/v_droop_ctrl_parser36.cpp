 ...
 *
 *
 *       v_droop_ctrl_parser36.cpp
 *       Created on: February 17, 2025
 *           Author: Bruce Palmer
 */
#include "v_droop_ctrl_parser36.hpp"
 ...
 */
gridpack::parser::VDroopCtrlParser36::VDroopCtrlParser36(
 ...
 * Simple Destructor
 */
gridpack::parser::VDroopCtrlParser36::~VDroopCtrlParser36(void)
{
}

/*
 * parse voltage droop control block. Currently does not store data
 * @param stream input stream that feeds lines from RAW file
 */
void gridpack::parser::VDroopCtrlParser36::parse(
