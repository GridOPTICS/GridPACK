 ...
 *
 *
 * switched_shunt_parser34.hpp
 *       Created on: December 9, 2022
 *           Author: Bruce Palmer
 */
#ifndef _SWITCHED_SHUNT_PARSER34_H
#define _SWITCHED_SHUNT_PARSER34_H
...
class SwitchedShuntParser34 : public BaseBlockParser {
  public:
  /**
   * Constructor
   ...
   * Simple Destructor
   */
  virtual ~SwitchedShuntParser34(void);
