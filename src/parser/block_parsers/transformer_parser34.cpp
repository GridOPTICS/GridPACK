 ...
 * @param branch_map map bus index pair in RAW file to
 internal indices
 */
gridpack::parser::TransformerParser34::TransformerParser34(
 ...
 * Simple Destructor
 */
gridpack::parser::TransformerParser34::~TransformerParser34(void)
{
}
 ...
 * @param maxBusIndex maximum value of bus index for any bus
 in system
 */
void gridpack::parser::TransformerParser34::parse(
  ...
  while(test_end(line)) {
    ...
    if (k != 0) {
      ...
      p_branchData[l_idx]->addValue(TRANSFORMER_RMA,
          atof(split_line3[17].c_str()),nelems);
