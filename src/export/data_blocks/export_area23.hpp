 ...
 * export_area23.hpp
 *
 * This class exports area data in PSS/E v23 format
 *
 *  Created on: July 9, 2021
 *      Author: Bruce Palmer
 */

#ifndef EXPORTAREA23_HPP_
#define EXPORTAREA23_HPP_
...
class ExportArea23
{
  public:
     ...
     * Constructor
     */
    explicit ExportArea23(boost::shared_ptr<_network> network) :
    ...
    void writeAreaBlock(std::ofstream &fout)
    {
      ...
      if (me == 0) {
        fout << "0 / END TRANSFORMER ADJUSTMENT DATA, BEGIN AREA DATA" << std::endl;
        int narea;
