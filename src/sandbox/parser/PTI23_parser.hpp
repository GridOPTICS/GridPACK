...
template <typename BUS, typename BRANCH>
class PTI23_parser {
public:
...
X            */
            ...
            transformer_instance.TRANSFORMER_NOMV2(data);
            ...
            transformer_instance.TRANSFORMER_CR1(data);
