 ...
 * @date   2015-05-05 10:10:49 d3g096
 * 
 * @brief  
 * 
 * 
...
public:
  ...
  typedef DAESolverImplementation::JacobianBuilder JacobianBuilder;
  typedef DAESolverImplementation::FunctionBuilder FunctionBuilder;
